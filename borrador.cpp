...
int main(){
    ...
    cout<<"------------------------------------------";
    cout<<"(5) CONSOLA / nintendo switch  / 500.bs";
    cout<<"(6) CONSOLA /nintendo switch - lite / 500.bs";
    cout<<"(7) MANDO / nintendo -  joy-con / 5bs";
    cout<<"(8) MANDO / nintendo - Mando-Pro  / 5bs";
    cout<<"(9) MANDO / nintendo - volantes-Mando/3bs";
    cout<<"(10) FUNDA / nintendo - Funda   / 3bs ";
    cout<<"------------------------------------------";
    cout<<"(11) CONSOLA / PLAYSTATION 4 / 500.bs";
    cout<<"(12) CONSOLA / PLAYSTATION 4 - PRO / 500.bs";
    cout<<"(13) CONSOLA / PLAYSTATION 5 / 500.BS";
    cout<<"(14) CONSOLA / PLAYSTATION 5 -Edicion Digital/ 500.bs";
    cout<<"(15) MANDO / PLAYSTATION 4 - DUALSHOCK - Inalambrico / 5bs";
    cout<<"(16) MANDO / PLAYSTATION 5 - DUALSENSE - Inalambrico / 5bs";
    cout<<"(17) MANDO / PLAYSTATION 5 - CONTROL - Access/ 5bs";
    cout<<"(18) MANDO / PLAYSTATION 5 - VOLNATE - Inalmbrico/ 5bs";
    cout<<"------------------------------------------";
    cout<<"(19) CONSOLA / SEGA - MARK III / 500.bs";
    cout<<"(20) CONSOLA / SEGA - MASTER SYSTEM / 500.bs";
    cout<<"(21) MANDO / SEGA - MEGA DRIVE / 500.bs ";
    cout<<"(22) MANDO / SEGA - MARK III - mando / 5.bs";
    cout<<"(23) MANDO / SEGA - MASTER SYSTEM - mando / 5bs";
    cout<<"(24) MANDO / SEGA - MEGA DRIVE - mando / 5bs";
    cout<<"-----------------------------------------";
